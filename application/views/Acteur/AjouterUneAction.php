            ...
            <section >
                <div class = "section-inner" style="background-color:#139CBC;padding:20px">
                    ...
                    echo '<div class="form-group">';
                        ...
                        echo form_input('SiteURL', '', Array("placeholder"=>"https://www.exemple.fr","class"=>"form-control",'pattern'=>$regex,'title'=>'http(s)://exemple.fr ou ftp://exemple.fr'));//,'pattern'=>'(((ht|f)tp(s?))\:\/\/)?(([a-zA-Z0-9]+([@\-\.]?[a-zA-Z0-9]+)*)(\:[a-zA-Z0-9\-\.]+)?@)?(www.|ftp.|[a-zA-Z]+.)?[a-zA-Z0-9\-\.]+\.([a-zA-Z]{2,})(\:[0-9]+)'
                    echo '</div>';
