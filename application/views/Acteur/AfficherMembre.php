    ...
    <div class='col-xs-2'>
        <nav class="navbar" data-spy="affix">
            <ul class="nav nav-pills nav-stacked" style="background-color:#B64F53;border-radius:10px;">
                <li>
                    <a href="<?php echo site_url('Acteur/AjoutMembre/'.$noAction); ?>" class="option" id='AjouterMembre'>
                        <H4>
                ...
                <li>
                    <a href="<?php echo site_url('Acteur/EnvoieMail/'.$noAction); ?>" class="option" id='EnvoieMail'>
                        <H4>
