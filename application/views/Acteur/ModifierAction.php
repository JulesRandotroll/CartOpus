                    ...
                    <?php
                        ...
                        echo '<div class="col-xs-4">';
                            echo '<div class="form-group">';
                                ...
                                echo form_input('CodePostale', '', Array("placeholder"=>"Code postale ex : 22000",'pattern'=>'([A-Z]+[A-Z]?\-)?[0-9]{1,2} ?[0-9]{3}','required'=>'required','class'=>'form-control'));
                            echo '</div>';
                        echo '</div>';
                        echo '<div class="col-xs-4">';
                            echo '<div class="form-group">';
                        ...
                        echo '<div class="col-xs-6">';
                            echo '<div class="form-group">';
                                ...
                                echo form_input('DateDebut', '', Array("placeholder"=>"Date ex : 11-11-2011",'required'=>'required','pattern'=>'(0[1-9]|[12][0-9]|3[01])[\/](0[1-9]|1[012])[\/](19|20)\d\d','class'=>'form-control'));
                            echo '</div>';
                        echo'</div>';
                        echo '<div class="col-xs-6">';
                            echo '<div class="form-group">';
