                    <ul class="nav navbar-nav navbar-right">
                        ...
                        else
                        {
                            ...
                            <li><a href="#" style="color:#FFFFFF"><span class="glyphicon glyphicon-plus"></span> Creation Action</a></li>
                            <li><a href="Acteur/GestionProfil" style="color:#FFFFFF"><span class="glyphicon glyphicon-cog"></span> Compte</a></li>
                        </ul>';
